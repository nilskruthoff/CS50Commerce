    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('img', django_resized.forms.ResizedImageField(blank=True, crop=['middle', 'center'], force_format=None, keep_meta=True, null=True, quality=100, size=[1080, 1080], upload_to='auctions/static/resources/%Y/%m/%d')),
                ('shipping', models.CharField(choices=[('1', 'Shipping possible'), ('2', 'Only Pickup')], default='1', max_length=2)),
